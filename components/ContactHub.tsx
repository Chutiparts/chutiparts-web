          ...
          <div className="relative bg-white w-full md:max-w-md md:rounded-2xl rounded-t-2xl shadow-2xl max-h-[92vh] overflow-y-auto">
            ...
            {view === 'menu' && (
              <div className="p-5 space-y-2.5">
                <a href={lineHref} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 w-full border border-gray-200 rounded-lg px-4 py-3.5 hover:bg-gray-50">
                  <span className="text-xl">🟢</span><span className="text-sm font-medium text-gray-800">LINE — {CONTACT.lineId}</span>
                </a>
                ...
                {waHref && (
                  <a href={waHref} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 w-full border border-gray-200 rounded-lg px-4 py-3.5 hover:bg-gray-50">
                    <span className="text-xl">🟩</span><span className="text-sm font-medium text-gray-800">WhatsApp</span>
                  </a>
                )}
                {fbHref && (
