...
export default function VinCheckPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      car_year: parseInt(formData.get('car_year') as string) || null,
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-lg p-6 md:p-8 space-y-4">
            ...
            <div>
              ...
              <input name="vin" type="text" required maxLength={17} minLength={17}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input name="car_year" type="number" min="1970" max="2010"
