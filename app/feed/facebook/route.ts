...
// ⚠️ ยังอยู่ในฟีดแต่ต้องตามต่อ: 140-004, 140-006 ใช้รูปชื่อ s-l1600*.webp
//    (s-l1600 = รูปแบบชื่อรูปของ eBay) → ต้องยืนยันสิทธิ์ใช้รูป และยืนยันว่า Commerce Manager
//    รับ webp จริง (สเปกที่ประกาศไว้คือ JPEG/PNG) ถ้าไม่ผ่านให้ย้ายมาไว้ใน EXCLUDED
// ─────────────────────────────────────────────────────────────────────────────
