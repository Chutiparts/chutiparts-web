...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/ops-x7k2m9')) {
    const TEAM_ALLOWED = ['/ops-x7k2m9/parts-desk', '/ops-x7k2m9/sync-stock', '/ops-x7k2m9/sourcing', '/ops-x7k2m9/sell', '/ops-x7k2m9/photo', '/ops-x7k2m9/add-part', '/ops-x7k2m9/unauthorized']
